...
export const siteConfig = {
  ...
  tagline: "Установка автоматических ворот под ключ",
  ...
  // SEO по умолчанию
  seo: {
    defaultTitle: "Премиум Ворота — установка автоматических ворот под ключ в [ГОРОД И РЕГИОН]",
    defaultDescription:
      "Изготовление, монтаж и автоматизация откатных, секционных и распашных ворот в [ГОРОД И РЕГИОН]. Замер, установка и гарантия на работы.",
    siteUrl: "https://premium-vorota.example",
    ogImageAlt: "Премиум Ворота — установка ворот под ключ",
  },

...
return [
    ...
    // Сколько секунд ждать почтовый сервер. Пока идёт отправка, покупатель
    // смотрит на индикатор, поэтому ждать долго нельзя: заказ к этому моменту
    // уже сохранён в базе и не потеряется. Поднимите, если ваша почта
    // отвечает медленно.

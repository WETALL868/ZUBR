...
CREATE TABLE IF NOT EXISTS categories (
  ...
  request_goal   VARCHAR(190) NULL,
  grid_anchor    VARCHAR(60)  NULL,
  request_badge  VARCHAR(60)  NULL,
  request_status VARCHAR(60)  NULL,
  request_tags   TEXT    NULL,
  request_title  VARCHAR(190) NULL,
  request_text   TEXT    NULL,
  request_button VARCHAR(120) NULL,
  cross_text     TEXT    NULL,
  cross_button   VARCHAR(120) NULL,
  footer_text    TEXT    NULL,
  yml_name       VARCHAR(190) NULL,
...
CREATE TABLE IF NOT EXISTS pages (
  ...
  og_desc      TEXT    NULL,
  og_image     VARCHAR(255) NULL,
  tw_title     VARCHAR(255) NULL,
  tw_desc      TEXT    NULL,
  keywords     TEXT    NULL,
  preload_image VARCHAR(255) NULL,
  noindex      TINYINT(1)    NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS home_blocks (
  ...
  kind        VARCHAR(20)  NOT NULL DEFAULT 'html',
  title       VARCHAR(255) NULL,
  subtitle    TEXT    NULL,
